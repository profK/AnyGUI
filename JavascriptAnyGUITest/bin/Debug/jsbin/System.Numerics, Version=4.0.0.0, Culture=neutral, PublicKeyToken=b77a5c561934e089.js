...
(function BigInteger$Members () {
  ...
  JSIL.MakeType({
    ...
    $.ExternalMethod({Static:false, Public:true }, ".ctor", 
      ...
      .Attribute($asm0B.TypeRef("System.CLSCompliantAttribute"), function () { return [false]; })
      .Attribute($asm08.TypeRef("__DynamicallyInvokableAttribute"));
    ...
    $.ExternalMethod({Static:true , Public:true }, "op_Explicit", 
      new JSIL.MethodSignature($.Type, [$asm0B.TypeRef("System.Decimal")])
    )
      .Attribute($asm08.TypeRef("__DynamicallyInvokableAttribute"));
    ...
    $.ExternalMethod({Static:true , Public:true }, "op_Explicit", 
      new JSIL.MethodSignature($asm0B.TypeRef("System.Decimal"), [$.Type])
    )
      .Attribute($asm08.TypeRef("__DynamicallyInvokableAttribute"));
    ...
    $.ExternalMethod({Static:true , Public:true }, "Parse", 
      new JSIL.MethodSignature($.Type, [$.String, $asm0B.TypeRef("System.Globalization.NumberStyles")])
    )
      .Attribute($asm08.TypeRef("__DynamicallyInvokableAttribute"));

    $.ExternalMethod({Static:true , Public:true }, "Parse", 
      new JSIL.MethodSignature($.Type, [$.String, $asm0B.TypeRef("System.IFormatProvider")])
    )
      .Attribute($asm08.TypeRef("__DynamicallyInvokableAttribute"));

    $.ExternalMethod({Static:true , Public:true }, "Parse", 
      new JSIL.MethodSignature($.Type, [
          $.String, $asm0B.TypeRef("System.Globalization.NumberStyles"), 
          $asm0B.TypeRef("System.IFormatProvider")
        ])
    )
      .Attribute($asm08.TypeRef("__DynamicallyInvokableAttribute"));
    ...
    $.ExternalMethod({Static:false, Public:true }, "ToString", 
      new JSIL.MethodSignature($.String, [$asm0B.TypeRef("System.IFormatProvider")])
    )
      .Attribute($asm08.TypeRef("__DynamicallyInvokableAttribute"));
    ...
    $.ExternalMethod({Static:false, Public:true , Virtual:true }, "ToString", 
      new JSIL.MethodSignature($.String, [$.String, $asm0B.TypeRef("System.IFormatProvider")])
    )
      .Attribute($asm08.TypeRef("__DynamicallyInvokableAttribute"));
    ...
    $.ExternalMethod({Static:true , Public:true }, "TryParse", 
      new JSIL.MethodSignature($.Boolean, [
          $.String, $asm0B.TypeRef("System.Globalization.NumberStyles"), 
          $asm0B.TypeRef("System.IFormatProvider"), $jsilcore.TypeRef("JSIL.Reference", [$.Type])
        ])
    )
      .Attribute($asm08.TypeRef("__DynamicallyInvokableAttribute"));
    ...
    $.ImplementInterfaces(
      /* 0 */ $asm0B.TypeRef("System.IFormattable"), 
      /* 1 */ $asm0B.TypeRef("System.IComparable"), 
      /* 2 */ $asm0B.TypeRef("System.IComparable`1", [$.Type]), 
      /* 3 */ $asm0B.TypeRef("System.IEquatable`1", [$.Type])
    );
...
(function Complex$Members () {
  ...
  JSIL.MakeType({
    ...
    $.ImplementInterfaces(
      ...
      /* 1 */ $asm0B.TypeRef("System.IFormattable")
    );
  ...
  JSIL.MakeStaticClass("System.Numerics.BigNumber", false, [], function ($interfaceBuilder) {
    ...
    $.ExternalMethod({Static:true , Public:false}, "FormatBigInteger", 
      new JSIL.MethodSignature($.String, [
          ...
          $asm0B.TypeRef("System.Globalization.NumberFormatInfo")
        ])
    )
    ...
    $.ExternalMethod({Static:true , Public:false}, "FormatBigIntegerToHexString", 
      new JSIL.MethodSignature($.String, [
          ...
          $.Int32, $asm0B.TypeRef("System.Globalization.NumberFormatInfo")
        ])
    );
    ...
    $.ExternalMethod({Static:true , Public:false}, "TryParseBigInteger", 
      new JSIL.MethodSignature($.Boolean, [
          $.String, $asm0B.TypeRef("System.Globalization.NumberStyles"), 
          $asm0B.TypeRef("System.Globalization.NumberFormatInfo"), $jsilcore.TypeRef("JSIL.Reference", [$asm08.TypeRef("System.Numerics.BigInteger")])
        ])
    )
      .Attribute($asm0B.TypeRef("System.Security.SecuritySafeCriticalAttribute"));

    $.ExternalMethod({Static:true , Public:false}, "TryValidateParseStyleInteger", 
      new JSIL.MethodSignature($.Boolean, [$asm0B.TypeRef("System.Globalization.NumberStyles"), $jsilcore.TypeRef("JSIL.Reference", [$asm0B.TypeRef("System.ArgumentException")])])
    );
...
(function BigNumberBuffer$Members () {
  ...
  JSIL.MakeType({
    ...
    $.Field({Static:false, Public:true }, "digits", $asm0B.TypeRef("System.Text.StringBuilder")); 
